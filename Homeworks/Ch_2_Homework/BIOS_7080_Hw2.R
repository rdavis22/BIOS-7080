...
std_Premolt.prb6<-sd(serum_t3.prb6[1:5], na.rm=T)
...
std_Fast.prb6<-sd(serum_t3.prb6[6:10], na.rm=T)
...
std_60.prb6<-sd(serum_t3.prb6[11:15], na.rm=T)
...
std_80.prb6<-sd(serum_t3.prb6[16:20], na.rm=T)
...
std_LM.prb6<-sd(serum_t3.prb6[21:25], na.rm=T)
